        ...
        return items.map((menuItem, index) => (
            ...
            >
                {menuItem.child_items.length > 0 ? (
                    <>
                        <Link className="nav-link" href={menuItem.url} onClick={(e) => handleSubMenuToggle(e, index, level)}>
                            {menuItem.title}
                        </Link>
                    ...
                    <Link className="nav-link" href={menuItem.url}>{menuItem.title}</Link>
                )}
            </li>
        ));
    };
    ...
    return (
        <header className="main-header">
            ...
            <div className="container bottom-header">
                <div className="logo">
                    <Link href="/"><Image src={logoUrl} alt="logo" layout="responsive" width={100} height={100} /></Link>
                </div>
